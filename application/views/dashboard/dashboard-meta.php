        ...
        <div class="col-lg-12 mb-1">
            <div class="row">
                <div class="col-md-12 mb-2">
                    <h3 class="text-primary fw-600">DASHBOARD META ADS ACNENO SYSTEM</h3>
                </div>
            </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody id="table-body">
                                ...
                                <?php foreach ($ads as $ad): ?>
                                    <tr>
                                        ...
                                        <td><?= 'Rp ' . number_format($ad['purchases'], 0, ',', '.') ?></td>
                                        <td><?= 'Rp ' . number_format((float)$ad['add_to_cart'], 0, ',', '.') ?></td>
                            ...
                            <tfoot style="max-height: 400px; position: sticky; bottom: 0; z-index: 1;">
                                <tr style=" font-weight: bold; background-color: #f2f2f2;">
                                    ...
                                    <td><?= 'Rp ' . number_format($totalAddToCart, 0, ',', '.') ?></td>
